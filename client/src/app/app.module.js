...
var lang_selector_service_1 = require("./shared/lang-selector/lang-selector.service");
var lang_selector_component_1 = require("./shared/lang-selector/lang-selector.component");
var langs_loader_service_1 = require("./shared/lang-selector/langs-loader.service");
var AppModule = (function () {
    function AppModule(langSelectorService) {
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        providers: [login_service_1.LoginService, register_service_1.RegisterService, product_service_1.ProductService, user_guard_1.UserGuard, custom_http_1.customHttpProvider, alert_service_1.AlertService, logged_control_service_1.LoggedControlService, lang_selector_service_1.LangSelectorService, langs_loader_service_1.LangsLoaderService],
        declarations: [app_component_1.AppComponent, register_component_1.RegisterComponent, login_component_1.LoginComponent, home_component_1.HomeComponent, top_menu_component_1.TopMenuComponent, alert_component_1.AlertComponent, product_list_component_1.ProductListComponent,
            product_specs_component_1.ProductSpecsComponent, product_overview_component_1.ProductOverviewComponent, product_component_1.ProductComponent, lang_selector_component_1.LangSelectorComponent],
