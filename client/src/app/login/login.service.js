...
var LoginService = (function () {
    function LoginService(http, loggedControlService) {
        this.http = http;
    ...
    LoginService.prototype.login = function (username, password) {
        ...
        return this.http.post('/users/login', { username: username, password: password })
            ...
            if (user) {
                ...
                _this.loggedControlService.login(user);
            }
            return user;
        });
    };
...
LoginService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http, logged_control_service_1.LoggedControlService])
], LoginService);
